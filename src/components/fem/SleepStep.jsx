...
const options = [
  { value: 'wakker_nachts', label: "Ik word 's nachts vaker wakker", icon: 'moon' },
  { value: 'moeilijk_inslapen', label: 'Ik val moeilijker in slaap', icon: 'clock' },
  { value: 'niet_uitgerust', label: 'Ik slaap genoeg uren maar voel me niet uitgerust', icon: 'moon' },
  { value: 'geen_verandering', label: 'Weinig veranderd', icon: 'check' },
]

export default function SleepStep({ value, onChange, onNext, onBack, step = 2, totalSteps = 7 }) {
  return (
    <div style={{
      minHeight: '100vh',
      ...
      <h1 style={{
        ...
        Hoe is je slaap, vergeleken met een jaar geleden?
      </h1>
