...
const options = [
  ...
  { value: 'mood', label: 'Mijn stemming verrast me', icon: 'moon' },
  { value: 'cycle', label: 'Mijn cyclus voelt anders', icon: 'circle' },
  { value: 'idk', label: 'Ik weet het niet — er is gewoon íets veranderd', icon: 'help' },
]

export default function ReasonStep({ value, onChange, onNext, onBack, step = 1, totalSteps = 7 }) {
  return (
    <div style={{
      minHeight: '100vh',
