...
const options = [
  ...
  { value: 'let_er_niet_op', label: 'Ik let er niet zo op', icon: 'help' },
  { value: 'nvt', label: 'Niet van toepassing', icon: 'check' },
]

export default function CycleStep({ value, onChange, onNext, onBack, step = 6, totalSteps = 7 }) {
  return (
    <div style={{
      minHeight: '100vh',
      ...
      <p style={{
        ...
        Dit mag je overslaan — gevoelige vraag. Geen judgment.
      </p>
