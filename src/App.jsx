...
import SmartQuiz from '../src/pages/SmartQuiz'
import QuizResults from '../src/pages/QuizResults'
import SigninPage from '../src/pages/auth/SigninPage'
import Landing from '../src/pages/wab/Landing'
import MenstruationTracker from '../src/pages/health/MenstruationTracker'
import PerimenopauzeTracker from '../src/pages/health/PerimenopauzeTracker'
import CycleAnalytics from '../src/pages/health/CycleAnalytics'
import WearableCycle from '../src/pages/health/WearableCycle'
import Results from '../src/pages/wab/Results'
import DashboardHome from '../src/pages/wab/DashboardHome'
import QuizResultsPage from '../src/pages/wab/QuizResultsPage'
import LearningHub from '../src/pages/wab/LearningHub'
import ProgressAnalytics from '../src/pages/wab/ProgressAnalytics'
import Dashboard from '../src/pages/wab/Dashboard'
...
import ConsentManagement from '../src/pages/account/ConsentManagement'
import FemLanding from '../src/pages/fem/FemLanding'
import FemQuizFunnel from '../src/pages/fem/FemQuizFunnel'
import SymptomLoggerPage from '../src/pages/wab/SymptomLoggerPage'
import LifestyleCheckPage from '../src/pages/wab/LifestyleCheckPage'
import WearableDashboard from '../src/pages/wab/WearableDashboard'
import SupplementsPage from '../src/pages/wab/SupplementsPage'
import { getToken, clearToken, verifyMagicLink, getMe } from '@shared/api/client'
