...
// Wel uitleg en context, met "bespreek het met je huisarts" waar dat hoort.
...
export const ARTIKELEN = [
    ...
    body: [
      {
        ...
        tekst: 'Een cyclus loopt van de eerste dag van je menstruatie tot de dag voor de volgende. Het gemiddelde is 28 dagen, maar alles tussen 21 en 35 dagen geldt als gebruikelijk. Ook binnen één persoon verschilt het van maand tot maand. Een paar dagen variatie is geen afwijking; het is hoe lichamen werken.',
      },
      {
      ...
      },
      {
        ...
        tekst: 'Pas als je een paar cycli hebt vastgelegd, zie je jóuw patroon. Daarna kun je afwijkingen daarvan herkennen. Daarom draait Ovari om de logknop: één tik per cyclusstart is genoeg om je eigen referentiekader op te bouwen.',
      },
    ],
  },
  {
    ...
    body: [
      {
        kop: 'Eerst de termen',
        tekst: 'Menopauze is één moment: een jaar na je laatste menstruatie. Alles daarvóór heet perimenopauze, de jaren waarin cycli en hormonen gaan schommelen. Die fase begint gemiddeld tussen de 40 en 44, maar eerder of later komt veel voor. De fase kan twee tot tien jaar duren.',
      },
      {
  ...
  },
  {
    ...
    body: [
      {
        kop: 'De rekensom',
        tekst: 'Met elke menstruatie verlies je bloed en daarmee ijzer. Bij hevige menstruaties kan dat verlies groter zijn dan wat een doorsnee voedingspatroon aanvult. IJzertekort is bij menstruerende vrouwen een van de meest voorkomende tekorten. Vermoeidheid is vaak het eerste merkbare gevolg.',
      },
      {
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        tekst: 'De kracht van een wearable zit niet in de precisie van één nacht maar in de consistentie: hij meet jou elke nacht op dezelfde manier. Systematische veranderingen zijn betrouwbaar zichtbaar, ook als de absolute getallen iets afwijken. Denk aan een rusthartslag die weken stijgt of een slaapduur die structureel zakt.',
      },
      {
